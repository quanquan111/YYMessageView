...
-(void)showMessageByImageNamed:(NSString *)imageNamed andTitle:(NSString *)titleText andDetail:(NSString *)detailText andSender:(BOOL)sender
{
    ...
    //需要显示的图片
    UIImage *showImage = [UIImage imageNamed:[NSString stringWithFormat:@"YYMessageImage.bundle/%@.png",imageNamed]];
    //计算图片的Y坐标
...
-(UIButton *)actionButton
{
    if (!_actionButton) {
        ...
        //        [_actionButton setBackgroundColor:self.operationColor];
